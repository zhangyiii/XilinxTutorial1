...
CONFIG.Read_Width_B.VALUE_SRC {DEFAULT} \
...
CONFIG.Write_Width_B.VALUE_SRC {DEFAULT} \
...
CONFIG.PCW_CAN_PERIPHERAL_DIVISOR1 {3} \
...
CONFIG.PCW_WDT_WDT_IO.VALUE_SRC {DEFAULT} \
  ...
  regenerate_bd_layout -layout_string {
   guistr: "# # String gsaved with Nlview 6.5.11  2015-11-26 bk=1.3515 VDI=39 GEI=35 GUI=JA:1.6
#  -string -flagsOSRD
