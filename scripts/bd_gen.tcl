...
if {$currVer eq "2016.1"} {
   source $thisDir/bd_cip_2016.1.tcl
} elseif {$currVer eq "2016.2"} {
   source $thisDir/bd_cip_2016.2.tcl 
} else {
...
# Generate Target
set_property synth_checkpoint_mode Singular [get_files */zynq_bd.bd]
#create_fileset -blockset -define_from zynq_bd zynq_bd
generate_target all [get_files */zynq_bd.bd]
create_ip_run [get_files */zynq_bd.bd]
