. c:/Xilinx/vivado/2015.1/.settings64-vivado.sh
...
#export PATH=/c/Xilinx/Vivado_HLS/$VER/bin:$PATH

## CALL C:\Xilinx\SDK\2014.2\.settings64-Software_Development_Kit.bat
#export PATH=/c/Xilinx/SDK/$VER/bin:/c/Xilinx/SDK/$VER/gnu/microblaze/nt/bin:/c/Xilinx/SDK/$VER/gnu/arm/nt/bin:/c/Xilinx/SDK/$VER/gnu/microblaze/linux_toolchain/nt64_be/bin:/c/Xilinx/SDK/$VER/gnu/microblaze/linux_toolchain/nt64_le/bin:$PATH
