...
//               /sampa/home/gyorgym/ug1198-vivado-revision-control/revCtrl/work/zynq_bd/zynq_bd_stub.v
// Design      : zynq_bd
...
module zynq_bd(DDR_addr, DDR_ba, DDR_cas_n, DDR_ck_n, DDR_ck_p, 
  ...
  FIXED_IO_ps_srstb, LEDs_4Bits_tri_o, ap_clk, ap_rst_n, bftClk, error, mux_V, reset, 
  video_in_stream_tdata, video_in_stream_tlast, video_in_stream_tready, 
  video_in_stream_tuser, video_in_stream_tvalid, video_out_stream_tdata, 
  video_out_stream_tlast, video_out_stream_tready, video_out_stream_tuser, 
  video_out_stream_tvalid, wbClk, wbDataForInput, wbDataForOutput, wbInputData, wbOutputData, 
  wbWriteOut)
